...
function fancy_lab_customizer( $wp_customize ){
   ...
   $wp_customize->add_section(
		...
		// Field 6 - Slider Button URL Number 3
	...
	$wp_customize->add_section(
		...
		// Field 1 - Popular Products Max Number 
		...
		// Field 1 - Popular Products Max Columns
		...
		// Field 1 - New Arrivals Products Max Number 
		...
		// Field 1 - New Arrivals Products Max Columns
